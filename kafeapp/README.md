...
## Neintuitivni část GUI - v admin view Kafaři lze upravit počet káv naklikaných kafařem - dvojklik do buňky, případně klik a psát.
...
6. Předpřipravení kafaři jsou vždy login-heslo: Vaclav-vaclav, Honza-honza, Pavel-pavel, Marak-marak
